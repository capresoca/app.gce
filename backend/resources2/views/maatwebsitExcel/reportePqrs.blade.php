    ...
    <table>
        ...
        @foreach($pqrsds as $pqr)
            <tr>
                ...
                <td>{{$pqr->afiliado ? ('Télefono: '. ($pqr->afiliado->telefono_fijo ? $pqr->afiliado->telefono_fijo : '###').' - Celular: '. ($pqr->afiliado->celular ? $pqr->afiliado->celular : '###').' - Correo Electrónico: ' . ($pqr->afiliado->correo_electronico ? $pqr->afiliado->correo_electronico : '###'))  : ''}}</td>
            </tr>
        @endforeach
        </tbody>
    </table>
