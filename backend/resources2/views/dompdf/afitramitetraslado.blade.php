    ...
    <div id="fila-3">
        ...
        <div id="regimen" class="celda">
            ...
            <div class="txt" id="txt-3-a">
                A. Contributivo
                <div class="check">
                    {{$afitramite->afiliado->as_regimene_id === 1 ? 'X' : '' }}
                </div>
            </div>
            ...
            <div class="txt" id="txt-3-b">
                ...
                <div class="check" id="check-3-b">
                    {{$afitramite->afiliado->as_regimene_id ===2 ? 'X' : '' }}
                </div>
            </div>
    ...
    <div id="fila-4">
        ...
        <div id="tipo-cotizante" class="celda">
            ...
            <div class="txt" id="txt-5-a">
                A. Dependiente
                <div class="check">
                    {{$afitramite->afiliado->as_tipcotizante_id === 1 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-5-b">
                B. Independiente
                <div class="check">
                    {{$afitramite->afiliado->as_tipcotizante_id === 2 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-5-c">
                C. Pensionado
                <div class="check">
                    {{$afitramite->afiliado->as_tipcotizante_id === 3 ? 'X' : '' }}
                </div>
            </div>
