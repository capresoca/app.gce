...
class RipAUInformeExport implements FromView, WithEvents, WithCharts
{
    ...
    {
        return view('maatwebsitExcel.reporteRIPAU', ['rips' => $this->data]);
    }
    ...
    public function firstSheet (Worksheet $spreadsheet)
    {
        try {
            ...
            $spreadsheet->getStyle('A1:Y1')->applyFromArray([
                'font' => [
                    'size' => 9,
                    'bold' => true,
                    'name' => 'Calibri'
            ...
            $spreadsheet->getStyle('A1:Y1')->getFill()
                ->applyFromArray(
