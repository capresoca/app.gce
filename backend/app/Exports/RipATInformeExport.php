...
class RipATInformeExport implements FromView, WithEvents, WithCharts
{
    ...
    {
        return view('maatwebsitExcel.reporteRIPAT', ['rips' => $this->data]);
    }
    ...
    public function firstSheet (Worksheet $spreadsheet)
    {
        try {
            ...
            $spreadsheet->getStyle('A1:S1')->applyFromArray([
                'font' => [
                    'size' => 9,
                    'bold' => true,
                    'name' => 'Calibri'
            ...
            $spreadsheet->getStyle('A1:S1')->getFill()
                ->applyFromArray(
