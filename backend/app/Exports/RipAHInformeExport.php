...
class RipAHInformeExport implements FromView, WithEvents, WithCharts
{
    ...
    {
        return view('maatwebsitExcel.reporteRIPAH', ['rips' => $this->data]);
    }
    ...
    public function firstSheet (Worksheet $spreadsheet)
    {
        try {
            ...
            $spreadsheet->getStyle('A1:Y2')->getAlignment()
            ...
            $spreadsheet->getColumnDimension('Z')->setWidth(30);
            $spreadsheet->getColumnDimension('AA')->setWidth(30);
            $spreadsheet->getColumnDimension('AB')->setWidth(30);

            $spreadsheet->setAutoFilter($spreadsheet->calculateWorksheetDimension());

            $spreadsheet->getStyle('A1:AB1')->applyFromArray([
                'font' => [
                    'size' => 9,
                    'bold' => true,
                    'name' => 'Calibri'
            ...
            $spreadsheet->getStyle('A1:AB1')->getFill()
                ->applyFromArray(
