...
class AfiliadoRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules =  [
            ...
            'fecha_expedicion' => 'required|date_format:d/m/Y',
        ...
        if($tipo_doc && !$this->id){
            ...
            $rules['fecha_nacimiento'] = 'required|date_format:d/m/Y|before:'.$fecha_nacimiento_min.'|after_or_equal:'.$fecha_nacimiento_max;
        }
