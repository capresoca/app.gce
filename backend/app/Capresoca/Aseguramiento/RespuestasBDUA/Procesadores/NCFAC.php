...
class NCFAC extends Procesador implements ProcesadorCSVInterface
{
        ...
        foreach ($this->data as $novedad) {
            try {
                ...
                if($afiliado){
                    ...
                    $this->pushMonitor('Se proceso Novedad Contributivo : '.$novedad[2].' - '.$novedad[3],$this->proceso,'console-success');
                }
            }catch (\Exception $e){
