...
abstract class Procesador
{
    ...
    protected function crearGnArchivo()
    {
        return GnArchivo::create(
            [
                'ruta' => $this->csvPath,
                'size' => 1,//Storage::size($this->csvPath),
    ...
    protected function pushMonitor($message=NULL, AsBduaproceso $proceso=NULL, $class=NULL)
    {
        Log::info('Mensaje: entra: ',array($message));
       /* broadcast(
            new BduaProcesosEvent(
                [
                    "type" => "monitor",
    ...
    protected function pushAvance(AsBduaproceso $bduaproceso=NULL, AsBduarespuesta $respuesta=NULL)
    {
