 ...
 *
 * Class RecLogBancarioDetalleAportanteSgp
 * @package App\Models\RecCompensacion
 */

class RecLogBancarioDetalleAportanteSgp extends Model implements Auditable
{
    use \OwenIt\Auditing\Auditable;
    use PimpableTrait;

    protected $primaryKey = 'consecutivo_log_detalle_aportante_sgp';
    protected $fillable = [
