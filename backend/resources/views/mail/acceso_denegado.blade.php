								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									<tr>
										<td width="100%" colspan="3" align="center" style="padding-bottom:10px;padding-top:25px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<h2 >Capresoca - Validador de RIPS</h2>
												</div>
											</div>
										</td>
									</tr>
									<tr>
										...
										<td width="400" align="center" style="padding-bottom:5px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<p ><strong>{{ $info->entidad }},</strong> el administrador negó tu solicitud de acceso al sistema</p>
													<p>Motivo: <strong>{{ $info->motivo }}</strong></p>
													<p>Para mas información ponte en contacto con la EPS Capresoca</p>
												</div>
											</div>
										</td>
										<td width="100">&nbsp;</td>
													...
													<td width="400" valign="top" style="padding-top:40px;padding-bottom:20px;">
														...
														<div class="contentEditableContainer contentTextEditable">
															<div class="contentEditable"  style="padding:20px 10px 0 0;margin:0;font-family:Helvetica, Arial, sans-serif;font-size:15px;line-height:150%;">
																<p style='color:#FFEECE;'>Se registro este correo al sistema de validador de RIPS de la EPS Capresoca para solicitar su acceso, el administrador del sistema NO habilito tu acceso al sistema.</strong></p>
															</div>
														</div>
								...
								<table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
									...
									<tr>
										<td width="60%" height="70" valign="middle" style="padding-bottom:20px;">
											<div class="contentEditableContainer contentTextEditable">
												<div class="contentEditable" >
													<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">enviado a por {{ env('APP_NAME') }}</span>
													<br/>
													...
													<span style="font-size:13px;color:#181818;font-family:Helvetica, Arial, sans-serif;line-height:200%;">
														<a target='_blank' href="[UNSUBSCRIBE]" style="text-decoration:none;color:#555">Clic aquí para cancelar credenciales</a></span>
												</div>
											</div>
										</td>
