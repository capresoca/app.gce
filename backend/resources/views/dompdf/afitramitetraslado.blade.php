...
<head>
    <meta charset="UTF-8">
    <title>Formulario Tramite de Traslado {{$afitramite ? 'No. Documento ' . $afitramite->identificacion : '' }}</title>
...
<div class="main">
    <div class="header">
        ...
        <div id="fecha-rad">
            @if($afitramite)
                @component('components.tabla_fecha',['fecha'=> $afitramite->fecha_radicacion_array])
                @endcomponent
            @endif
        </div>
        <div class="celda rad numero">
            ...
            <strong>{{str_pad($afitramite->consecutivo,6,"0",STR_PAD_LEFT)}}</strong>
        </div>
    </div>
    ...
    <div id="fila-3">
        ...
        <div id="tipo-afiliacion" class="celda">
            ...
            <div class="txt" id="txt-2-a-1">
                ...
                <div class="check">
                	{{$afitramite->afiliado->tipo_afiliado ? $afitramite->afiliado->tipo_afiliado->id === 1 ? 'X' : '' : ''}}
                    {{$afitramite->afiliado->tipo_afiliado ? $afitramite->afiliado->tipo_afiliado->id === 2 ? 'X' : '' : ''}}
                    {{--{{ $afitramite->afiliado ? $afitramite->afiliado->as_tipafiliado_id === 2 ? 'X' : '' : ''}}--}}
                    {{--{{$afitramite->afiliado->as_tipafiliado_id === 2 ? 'X' : ''}}--}}
                </div>
            </div>
            <div class="txt" id="txt-2-a-2">
                -Beneficiario o afiliado adicional
                <div class="check">
                	{{$afitramite->afiliado->tipo_afiliado ? $afitramite->afiliado->tipo_afiliado->id === 3 ? 'X' : '' : ''}}
                    {{--                    {{ $afitramite->afiliado ? $afitramite->afiliado->as_tipafiliado_id === 3 ? 'X' : '' : ''}}--}}
                    {{--{{$afitramite->afiliado->as_tipafiliado_id === 3 ? 'X' : ''}}--}}
                </div>
            </div>
        ...
        <div id="regimen" class="celda">
            ...
            <div class="txt" id="txt-3-a">
                A. Contributivo
                <div class="check">
                    {{(!is_null($afitramite->as_pagadore_id)) ? 'X' : '' }}
                </div>
            </div>
    ...
    <div id="fila-4">
        ...
        <div id="tipo-cotizante" class="celda">
            ...
            <div class="txt" id="txt-5-a">
                A. Dependiente
                <div class="check">
                    {{$afitramite->as_clasecotizante_id === 1 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-5-b">
                B. Independiente
                <div class="check">
                    {{$afitramite->as_clasecotizante_id === 3 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-5-c">
                C. Pensionado
                <div class="check">
                    {{$afitramite->as_clasecotizante_id === 21 ? 'X' : '' }}
                </div>
            </div>
            ...
            <div class="txt" id="check-5-e">
                {{'EPS'.($afitramite->as_pagadore_id ? 'C' : '0').'25'}}
{{--                {{$afitramite->claseCotizante ? $afitramite->claseCotizante->codigo : ''}}--}}
    ...
    <div>
        ...
        <table class="collapse" id="tabla-beneficiarios">
            ...
            <tr>
                <td>C</td>
                <td>{{$afitramite->afiliado->ips != null ? $afitramite->afiliado->ips->nombre : '' }}</td>
                <td class="last">{{$afitramite->afiliado->ips != null ? $afitramite->afiliado->ips->cod_habilitacion : '' }}</td>
            </tr>
            @if(!$afitramite->beneficiarios->count())
                @for($i = 1; $i<4; $i++)
                    <tr class="datos">
        ...
        <div id="fila-17">
            <div class="tit-campo" id="tit-v">
                V. DATOS DE IDENTIFICACIÓN DEL EMPLEADOR Y OTROS APORTANTES DE LAS ENTIDADES RESPONSABLES DE LA
        ...
        <div id="fila-18">
            <div class="celda" id="celda-35">
                ...
                <div id="dato-35">
                    {{$afitramite->pagador ? $afitramite->pagador['tercero']['nombre_completo'] : ''}}
                </div>
            </div>
            <div class="celda" id="celda-36">
                ...
                <div id="dato-36">
                    {{$afitramite->pagador ? $afitramite->pagador['tercero']['tipo_id']['abreviatura'] : ''}}
                </div>
            </div>
            <div class="celda" id="celda-37">
                ...
                <div id="dato-37">
                    {{$afitramite->pagador ? $afitramite->pagador['tercero']['identificacion'] : ''}}
                </div>
            </div>
            ...
            <div>
                @if($afitramite->pagador)
                    <div class="dato-39" style="width: 61mm;">
                        {{$afitramite->pagador['tercero']['direccion']}}
                    </div>
                    <div class="dato-39" style="width: 30mm">
                        {{$afitramite->pagador['tercero']['telefono_fijo']}}
                    </div>
                    <div class="dato-39" style="width: 40mm">
                        {{$afitramite->pagador['tercero']['correo_electronico']}}
                    </div>
                    <div class="dato-39" style="width: 37mm">
                        {{$afitramite->pagador['tercero']['municipio']['nombre']}}
                    </div>
                    <div class="dato-39" style="width: 33mm">
                        {{$afitramite->pagador['tercero']['municipio']['departamento']['nombre']}}
                    </div>
                @endif
            </div>
            <div>
        ...
        <div id="fila-21">
            ...
            <div id="col-40-2">
                ...
                <div>
                    <div class="check">{{$afitramite->tipo === 'Movilidad' ? 'X' : '' }}</div>
                    <span id="span-40-13">13. Movilidad:</span>
                    <div id="txt-40-13">
                        <div>
                            <div class="check" id="check-40-13-1">{{
                            $afitramite->tipo === 'Movilidad'
                            ? ($afitramite->eps['regimen'] === 'Contributivo' ? 'X' : '') : ''
                            }}</div>
                            <span>A. Régimen Contributivo</span>
                        </div>
                        <div>

                            <div class="check" id="check-40-13-2">{{
                            $afitramite->tipo === 'Movilidad'
                            ? ($afitramite->eps->regimen === 'Subsidiado' ? 'X' : '') : ''
                            }}
                            </div>
                ...
                <div>
                    <div class="check">{{$afitramite->tipo === 'Traslado' ? 'X' : '' }}</div>
                    <span id="span-40-13">14. Traslado: </span>
                    <div id="txt-40-13">
                        <div>

                            <div class="check" id="check-40-13-1">{{
                            $afitramite->tipo === 'Traslado'
                            ? (($afitramite->eps['regimen'] === 'Contributivo' && $afitramite->afiliado->as_regimene_id === 1)
                            || ($afitramite->eps['regimen'] === 'Subsidiado' && $afitramite->afiliado->as_regimene_id === 2)
                            ? 'X' : '') : ''
                            }}
                            </div>
                        ...
                        <div>
                            ...
                            <div class="check" id="check-40-13-2">{{
                            $afitramite->tipo === 'Traslado'
                            ? (($afitramite->eps['regimen'] === 'Subsidiado' && $afitramite->afiliado->as_regimene_id === 1)
                            || ($afitramite->eps['regimen'] === 'Contributivo' && $afitramite->afiliado->as_regimene_id === 2)
                            ? 'X' : '') : ''
                            }}</div>
                ...
                <div>
                    <div class="check">
                        {{$afitramite->as_clasecotizante_id === 18 ? 'X' : ''}}
                    </div>
                    <span>16. Reporte del tramite de protección al cesante.</span>
                </div>
                <div>
                    <div class="check">
                        {{$afitramite->as_clasecotizante_id === 28 ? 'X' : ''}}
                    </div>
        ...
        <div id="fila-24">
            ...
            <div id="celda-41-7">
                <div id="txt-41-7">Sexo &nbsp;&nbsp; Masculino
                    <div class="check"></div>
                    Femenino
                    <div class="check"></div>
                </div>
        ...
        <div id="fila-46">
            ...
            <div class="decl">
                <div class="check"></div>
                48. Declaración de existencia de razones de fuerza mayor o caso fortuito que impiden la entrega de los
                documentos de los beneficiarios.
            </div>
            <div class="decl">
                <div class="check"></div>
                49. Declaración de no internación del cotizante, cabeza de familia, beneficiario o afiliados adicionales
                en una institución Prestadora de Serviios de Salud.
            </div>
            <div class="decl">
                <div class="check"></div>
                50. Autorización para que la EPS solicite y obtenga datos y copia de la historia clínica del cotizante o
                cabeza de familia y de sus beneficiarios o afiliados adicionales.
            </div>
            <div class="decl">
                <div class="check"></div>
                51. Autorización para que la EPS reporte la información que se genere de la afiliación o del reporte de
                novedades a la base de datos de afiliados vigente y a las 5 entidades públicas que por sus funciones la
                requieran.
            </div>
            <div class="decl">
                <div class="check"></div>
                52. Autorización para que la EPS maneje los datos personales del cotizante o cabeza de familia y de sus
                beneficiarios o afiliados adicionales, de acuerdo con lo previsto en la Ley 1581 de 2012 y el Decreto
                1377 de 2013.
            </div>
            <div class="decl">
                <div class="check"></div>
                53. Autorización para que la EPS envíe información al correo electrónico o al celular como mensajes de
                texto.
            </div>
        </div>
        ...
        <div id="fila-48">
            ...
            <div class="decl">
                <div class="check"></div>
                58. Copia del registro civil de matrimonio, o de la Escritura pública, acta de conciliación o sentencia
                judicial que declara la unión marital.
            </div>
            <div class="decl">
                <div class="check"></div>
                59. Copia de la escritura pública o sentencia judicial que declare el divorcio, sentencia judicial que
                declare la separación de cuerpos y escritura pública, acta de
            ...
            <div class="decl">
                <div class="check"></div>
                62. Documento en que conste la pérdida de la patria potestad, o el certificado de defunción de los
                padres ola declaración suscrita por el cotizante sobre la ausencia de
                los dos padres.
            </div>
            <div class="decl">
                <div class="check"></div>
            ...
            <div class="decl">
                <div class="check"></div>
                65. Copia del acto administrativo o providencia de las autoridades competentes en la que conste la
                calidad de beneficiario o se ordene la afiliación de oficio.
            </div>
        </div>
        ...
        <div id="fila-53">
            Recuerde que con la firma del formulario, el afiliado manifiesta la veracidad de la información registrada y
            de las declaraciones contenidas en el capitulo VII del formulado.
        </div>
    </div>
    <div class="saltopagina"></div>
