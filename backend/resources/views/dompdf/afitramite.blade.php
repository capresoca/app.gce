...
<div class="main">
    ...
    <div id="fila-4">
        ...
        <div id="tipo-cotizante" class="celda">
            ...
            <div class="txt" id="check-5-e" style="font-size: 8px;">
                EPS025
            </div>
        </div>
    ...
    <div id="fila-10">
        ...
        <div class="celda" id="celda-17">
            ...
            <div class="txt" id="txt-15-2">
            	{{$afitramite->as_regimene_id ===2 ? '' : $afitramite->afiliado->ibc }}
            </div>
        </div>
    ...
    <div id="fila-12">
        ...
        <div class="txt" id="dato-18-7">
            ...
            @endif
            @if($afitramite->afiliado->barrio)
                {{$afitramite->afiliado->barrio->nombre}}
            @endif
        </div>
    ...
    <div>
        ...
        <table class="collapse" id="tabla-beneficiarios">
            <tbody>
                ...
                @if(!$afitramite->beneficiariosTotal->count())
                    @if(!$afitramite->nucleo_familiar->count())
                        @for($i = 1; $i<=4; $i++)
                        ...
                        @endfor
                    @else
                        @foreach($afitramite->nucleo_familiar as $beneficiario)
                            <tr class="datos">
                    ...
                    @endif
                @else
                    @foreach($afitramite->beneficiariosTotal as $beneficiario)
                        <tr class="datos">
                            <td>B{{$loop->iteration}}</td>
                            <td>{{$beneficiario->apellido1}}</td>
                            <td>{{$beneficiario->apellido2}}</td>
    ...
    @if($afitramite->beneficiariosTotal->count() >= 10)
    ...
    @endif
        ...
        <table class="collapse" id="tabla-beneficiarios">
            ...
            <tr>
                <td>C</td>
                <td>{{!$afitramite->ips?'':$afitramite->ips->nombre}}</td>
