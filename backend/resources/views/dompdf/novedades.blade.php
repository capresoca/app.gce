...
<div class="main">
    <div class="header">
        ...
        <div id="fecha-rad">
        @if($novedad->tramite)
            @component('components.tabla_fecha',['fecha'=> $novedad->tramite->fecha_radicacion_array])
                @endcomponent
            @endif
        </div>
        <div class="celda rad numero">
            ...
            <strong>{{str_pad($novedad->id,6,"0",STR_PAD_LEFT)}}</strong>
        </div>
    </div>
    ...
    <div id="fila-3">
        ...
        <div id="tipo-afiliacion" class="celda">
            ...
            <div class="txt" id="txt-2-a-1">
                ...
                <div class="check">
                    <!-- {{$novedad->afiliado->as_tipafiliado_id ===1 ? 'X' : '' }} -->
                    {{$novedad->afiliado->as_tipafiliado_id ===1 || $novedad->afiliado->as_tipafiliado_id ===2 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-2-a-2">
                -Beneficiario o afiliado adicional
                <div class="check">
					{{$novedad->afiliado->as_tipafiliado_id ===2 ? '' : 'X' }}
                </div>
            </div>
            <div class="txt" id="txt-2-b">
                B. Colectiva
                <div class="check">
                    {{$novedad->as_tipafiliacione_id ===2 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-2-c">
                C. Institucional
                <div class="check">
                    {{$novedad->as_tipafiliacione_id ===3 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-2-d">
                D. De Oficio
                <div class="check">
                    {{$novedad->as_tipafiliacione_id ===4 ? 'X' : '' }}
                </div>
            </div>
        </div>
        ...
        <div id="regimen" class="celda">
            ...
            <div class="txt" id="txt-3-a">
                A. Contributivo
                <div class="check">
                    {{$novedad->afiliado->as_regimene_id ===1 ? 'X' : '' }}
                </div>
            </div>
            ...
            <div class="txt" id="txt-3-b">
                ...
                <div class="check" id="check-3-b">
                    {{$novedad->afiliado->as_regimene_id ===2 ? 'X' : '' }}
                </div>
            </div>
    ...
    <div id="fila-4">
        <div id="tipo-afiliado" class="celda">
            ...
            <div class="txt" id="txt-4-c">
                C. Beneficiario
                <div class="check">
                    {{$novedad->afiliado->as_tipafiliado_id ===3 ? 'X' : '' }}
                </div>
            </div>
        </div>
        <div id="tipo-cotizante" class="celda">
            ...
            <div class="txt" id="txt-5-a">
                A. Dependiente
                <div class="check">
                    {{$novedad->afiliado->cabeza->as_tipcotizante_id ===1 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-5-b">
                B. Independiente
                <div class="check">
                    {{$novedad->afiliado->cabeza->as_tipcotizante_id ===2 ? 'X' : '' }}
                </div>
            </div>
            <div class="txt" id="txt-5-c">
                C. Pensionado
                <div class="check">
                    {{$novedad->afiliado->cabeza->as_tipcotizante_id ===3 ? 'X' : '' }}
                </div>
            </div>
            ...
            <div class="txt" id="check-5-e">
                {{$novedad->claseCotizante ? $novedad->claseCotizante->codigo : ''}}
            </div>
        </div>
    ...
    <div id="fila-6">
        ...
        <div class="dato txt" id="dato-6-1">
            {{$novedad->afiliado->cabeza->apellido1}}
        </div>
        <div class="dato txt" id="dato-6-2">
            {{$novedad->afiliado->cabeza->apellido2}}
        </div>
        <div class="dato txt" id="dato-6-3">
            {{$novedad->afiliado->cabeza->nombre1}}
        </div>
        <div class="dato txt" id="dato-6-4">
            {{$novedad->afiliado->cabeza->nombre2}}
        </div>
    ...
    <div id="fila-7">
        <div class="celda" id="celda-7">
            ...
            <div class="minicelda" id="check-7-1">
                {{$novedad->afiliado->cabeza->tipo_id->abreviatura}}
            </div>
        </div>
        <div class="celda" id="celda-8">
            ...
            <div class="txt" id="txt-8-1">
                {{$novedad->afiliado->cabeza->identificacion}}
            </div>
        </div>
        <div class="celda" id="celda-9">
            ...
            <div class="txt" id="txt-9-2">
                Femenino
                <div class="check">{{$novedad->afiliado->cabeza->gn_sexo_id === 1 ? 'X' : ''}}</div>
            </div>
            <div class="txt" id="txt-9-1">
                Masculino
                <div class="check">{{$novedad->afiliado->cabeza->gn_sexo_id === 2 ? 'X' : ''}}</div>
            </div>
        </div>
        ...
        <div id="fecha-10">
            @component('components.tabla_fecha',['fecha'=> $novedad->afiliado->cabeza->fecha_nacimiento_array])
            @endcomponent
        </div>
    </div>
    <div id="fila-8">
    ...
    <div id="fila-9">
        <div class="celda" id="celda-11">
            ...
            <div class="minicelda" id="check-11-1">
                @if($novedad->afiliado->cabeza->etnia)
                    {{$novedad->afiliado->cabeza->etnia->codigo}}
                @endif
            </div>
        </div>
        <div class="celda" id="celda-12">
            ...
            <div id="check-12-1">
                ...
                <div class="check">
                    F
                    <span>{{$novedad->afiliado->cabeza->as_tipo_discapacidade_id ===1 ? 'X': ''}}</span>
                </div>
                <div class="check">
                    N
                    <span>{{$novedad->afiliado->cabeza->as_tipo_discapacidade_id ===2 ? 'X': ''}}</span>
                </div>

                <div class="check">
                    M
                    <span>{{$novedad->afiliado->cabeza->as_tipo_discapacidade_id ===3 ? 'X': ''}}</span>
                </div>
            ...
            <div id="check-12-2">
                ...
                <div class="check">
                    T
                    <span>{{$novedad->afiliado->cabeza->as_condicion_discapacidades_id === 1 ? 'X': ''}}</span>
                </div>
                <div class="check">
                    P
                    <span>{{$novedad->afiliado->cabeza->as_condicion_discapacidades_id === 2 ? 'X': ''}}</span>
                </div>
        ...
        <div class="celda" id="celda-13">
            ...
            <div class="minicelda" id="check-13-1">
                {{$novedad->afiliado->cabeza->puntaje_sisben}}
            </div>
        </div>
        <div class="celda" id="celda-14">
            <div class="tit-campo">14. Grupo de población especial</div>
            <div class="minicelda" id="check-13-2">
                @if($novedad->afiliado->cabeza->poblacion_especial)
                    {{$novedad->afiliado->cabeza->poblacion_especial->codigo}}
                @endif
            </div>
        </div>
    </div>
    <div id="fila-10">
        <div class="celda" id="celda-15">
            ...
            <div class="txt" id="txt-15-1">
                {{!$novedad->afiliado->cabeza->arl ? '' :$novedad->afiliado->cabeza->arl->nombre}}
            </div>
        </div>
        ...
        <div class="celda" id="celda-16">
            ...
            <div class="txt" id="txt-15-2">
                {{!$novedad->afiliado->cabeza->afp ? '' :$novedad->afiliado->cabeza->afp->nombre}}
            </div>
        </div>
    ...
    <div id="fila-11">
        ...
        <div class="txt" id="dato-18-1">{{$novedad->afiliado->cabeza->direccion}}</div>
        <div class="txt" id="txt-18-1">Dirección</div>
        <div class="txt" id="dato-18-2">{{$novedad->afiliado->cabeza->telefono_fijo}}</div>
        <div class="celda-laterales txt" id="txt-18-2">Teléfono Fijo</div>
        <div class="txt" id="dato-18-3">{{$novedad->afiliado->cabeza->celular}}</div>
        <div class="celda-laterales txt" id="txt-18-3">Teléfono Celular</div>
        <div class="txt" id="dato-18-4">{{$novedad->afiliado->cabeza->correo_electronico}}</div>
        <div class="txt" id="txt-18-4">Correo Electrónico</div>

    </div>
    <div id="fila-12">
        <div class="txt" id="dato-18-5">
            {{$novedad->afiliado->cabeza->municipio->nombre}}
        </div>
        ...
        <div class="txt" id="dato-18-7">
            @if($novedad->afiliado->cabeza->vereda)
                {{$novedad->afiliado->cabeza->vereda->nombre}}
            @endif
        </div>
        <div class="txt celda-laterales" id="txt-18-7">
            ...
            <div class="txt" id="txt-18-7-2">
                ...
                <div class="check txt" id="check-18-7-2">
                    {{$novedad->afiliado->cabeza->gn_zona_id === 1 ? 'X' : ''}}
                </div>
            </div>
            <div class="txt" id="txt-18-7-3">
                Rural
                <div class="check txt" id="check-18-7-3">
                    {{$novedad->afiliado->cabeza->gn_zona_id === 2 ? 'X' : ''}}
                </div>
            </div>
        </div>
        <div class="txt" id="dato-18-8">
            {{$novedad->afiliado->cabeza->municipio->departamento->nombre}}
        </div>
    ...
    <div id="fila-14">
        <div id="fila-14">
            ...
            <div class="dato txt" id="dato-14-1">
                {{$novedad->afiliado->formulario->conyugue->apellido1}}
            </div>
            <div class="dato txt" id="dato-14-2">
                {{$novedad->afiliado->formulario->conyugue->apellido2}}
            </div>
            <div class="dato txt" id="dato-14-3">
                {{$novedad->afiliado->formulario->conyugue->nombre1}}
            </div>
            <div class="dato txt" id="dato-14-4">
                {{$novedad->afiliado->formulario->conyugue->nombre2}}
            </div>
            @endif
    ...
    <div id="fila-15">
        <div class="celda" id="celda-20">
            ...
            <div class="minicelda" id="check-20-1">
                @if($novedad->conyuge)
                {{$novedad->conyuge->tipo_id->abreviatura}}
                @endif
            </div>
        </div>
        <div class="celda" id="celda-21">
            ...
            <div class="txt" id="txt-21-1">
                @if($novedad->conyuge)
                {{$novedad->conyuge->identificacion}}
                @endif
            </div>
        </div>
        <div class="celda" id="celda-22">
            ...
            <div class="txt" id="txt-22-2">
                Femenino
                @if($novedad->conyuge)
                <div class="check">{{$novedad->conyuge->gn_sexo_id === 1 ? 'X' : ''}}</div>
                @endif
            </div>
            <div class="txt" id="txt-22-1">
                Masculino
                @if($novedad->conyuge)
                <div class="check">{{$novedad->conyuge->gn_sexo_id === 2 ? 'X' : ''}}</div>
                @endif
            </div>
        </div>
    ...
    <div>
        ...
        aqui van a ir los beneficiarios
        
        resto de beneficiaron
        ...
        <table class="collapse" id="tabla-beneficiarios">
            ...
            @if(!$novedad->afiliado->beneficiarios->count())
                @for($i = 1; $i<=4; $i++)
            ...
            @foreach($novedad->afiliado->beneficiarios as $beneficiario)
                <tr class="datos">
    ...
    @if($novedad->afiliado->beneficiarios->count() >= 10)
    ...
    @endif
        ...
        <table class="collapse" id="tabla-beneficiarios">
            ...
            <tr>
                <td>C</td>
                <td>{{!$novedad->ips?'':$novedad->ips->nombre_completo}}</td>
                <td class="last">{{!$novedad->ips?'':$novedad->ips->cod_habilitacion}}</td>
            </tr>
            @if(!$novedad->afiliado->beneficiarios->count())
                @for($i = 1; $i<4; $i++)
            ...
            @endif
            @foreach($novedad->afiliado->beneficiarios as $beneficiario)
                @if($beneficiario->rs_entidade_id !== $novedad->rs_ips_id)
                    <tr class="datos">
                        <td>B{{$loop->iteration}}</td>
        ...
        <div id="fila-18">
            <div class="celda" id="celda-35">
                ...
                <div id="dato-35">
                    {{$novedad->pagador ? $novedad->pagador->nombre_completo: ''}}
                </div>
            </div>
            <div class="celda" id="celda-36">
                ...
                <div id="dato-36">
                    {{$novedad->pagador ? $novedad->pagador->tipo_id->abreviatura : ''}}
                </div>
            </div>
            <div class="celda" id="celda-37">
                ...
                <div id="dato-37">
                    {{$novedad->pagador ? $novedad->pagador->identificacion : ''}}
                </div>
            </div>
            <div class="celda" id="celda-38">
                ...
                <div id="dato-37">
                    {{$novedad->pagador ? $novedad->pagador->tipo_aportante->codigo : ''}}
                </div>
            </div>
        </div>
        <div id="fila-18">
            ...
            <div>
                @if($novedad->pagador)
                    <div class="dato-39" style="width: 61mm;">
                        {{$novedad->pagador->direccion}}

                    </div>
                    <div class="dato-39" style="width: 30mm">
                        {{$novedad->pagador->telefono_fijo}}

                    </div>
                    <div class="dato-39" style="width: 40mm">
                        {{$novedad->pagador->correo_electronico}}

                    </div>
                    <div class="dato-39" style="width: 37mm">
                        {{$novedad->pagador->municipio->nombre}}

                    </div>
                    <div class="dato-39" style="width: 33mm">
                        {{$novedad->pagador->municipio->departamento->nombre}}
                    </div>
                @endif
            </div>
            <div>
        ...
        <div id="fila-21">
            <div id="col-40-1">
                <div>
                    <div class="check">{{$novedad->novedad->codigo==='N02' || $novedad->novedad->codigo==='N03' ? 'X' : ''}}</div>
                    <span>1. Modificación de datos básicos de identificación.</span>
                </div>
                <div>
                    <div class="check">{{$novedad->novedad->codigo==='N01' ? 'X' : ''}}</div>
                ...
                <div>
                    <div class="check">{{$novedad->novedad->codigo==='N04' || $novedad->novedad->codigo==='N19' || $novedad->novedad->codigo==='N20' || $novedad->novedad->codigo==='N32' || $novedad->novedad->codigo==='N21'  ? 'X' : ''}}</div>
                    <span>4. Actualización y corrección de datos complementarios.</span>
                </div>
                <div>
                    <div class="check">{{$novedad->novedad->codigo==='N14' ? 'X' : ''}}</div>
                    ...
                    <div class="check">{{$novedad->novedad->codigo==='N16' || $novedad->novedad->codigo==='N31' ? 'X' : ''}}</div>
                    <span>6. Reinscripción a la EPS.</span>
                </div>
                <div>
                    <div class="check">{{$novedad->novedad->codigo==='N07' ? 'X' : ''}}</div>
                ...
                <div>
                    <div class="check">{{$novedad->novedad->codigo==='N13' ? 'X' : ''}}</div>
                    <span>9. Inicio de relación laboral o adquisición de condiciones para cotizar.</span>
                </div>
                <div>
                    <div class="check">{{$novedad->novedad->codigo==='N11' ? 'X' : ''}}</div>
            ...
            <div id="col-40-2">
                ...
                <div>
                    <div class="check" >{{$novedad->novedad->codigo==='R1' ? 'X' : ''}}</div>
                ...
                <div>
                    <div class="check" >{{$novedad->novedad->codigo==='S1' ? 'X' : ''}}</div>
                ...
                <div>
                    <div class="check">{{$novedad->novedad->codigo==='N09' ? 'X' : ''}}</div>
        ...
        <div id="fila-23">
            ...
            @if($novedad->novedad->codigo==='N01' || $novedad->novedad->codigo==='N02' || $novedad->novedad->codigo==='N03')
                <div id="dato-41-1">{{$novedad->apellido1}}</div>
                <div id="dato-41-2">{{$novedad->apellido2}}</div>
                <div id="dato-41-3">{{$novedad->nombre1}}</div>
                <div id="dato-41-4">{{$novedad->nombre2}}</div>
            @endif
            @if($novedad->novedad->codigo!=='N01' && $novedad->novedad->codigo!=='N02' && $novedad->novedad->codigo!=='N03')
        ...
        <div id="fila-24">
            <div id="celda-41-5">
                <div id="txt-41-5">
                    ...
                    @if($novedad->novedad->codigo==='N01' || $novedad->novedad->codigo==='N02' || $novedad->novedad->codigo==='N03')
                    	<div class="check">{{$novedad->tipo_id->abreviatura}}</div>
                    @endif
                    @if($novedad->novedad->codigo!=='N01' && $novedad->novedad->codigo!=='N02' && $novedad->novedad->codigo!=='N03')
                    	<div class="check"></div>
                    @endif
            ...
            <div id="celda-41-6">
                ...
                @if($novedad->novedad->codigo==='N01' || $novedad->novedad->codigo==='N02' || $novedad->novedad->codigo==='N03')
                	<div id="dato-41-6">{{$novedad->identificacion}}</div>
                @endif
                @if($novedad->novedad->codigo!=='N01' && $novedad->novedad->codigo!=='N02' && $novedad->novedad->codigo!=='N03')
            ...
            <div id="celda-41-7">
                <div id="txt-41-7">
                	...
                	<div class="check">
                    	@if($novedad->novedad->codigo==='N01' || $novedad->novedad->codigo==='N02' || $novedad->novedad->codigo==='N03')	
                    		{{$novedad->afiliado->cabeza->gn_sexo_id === 2 ? 'X' : ''}}
                    	@endif
                	</div> 
                	Femenino 
                	<div class="check"> 
                    	@if($novedad->novedad->codigo==='N01' || $novedad->novedad->codigo==='N02' || $novedad->novedad->codigo==='N03')	
                    		{{$novedad->afiliado->cabeza->gn_sexo_id === 1 ? 'X' : ''}}
                    	@endif
                	</div>
            	</div>
            </div>
