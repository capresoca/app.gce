...
class CmTipocausalhospitalizacion extends Model implements Auditable
{
    use PimpableTrait;
    ...
    // Relaciones
    public function causal_hospitalizaciones() {
        return $this->hasMany(CmConcausalhospitalizacion::class);
    }
