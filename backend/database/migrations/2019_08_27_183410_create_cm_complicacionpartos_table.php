...
class CreateCmComplicacionpartosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cm_complicacionpartos', function (Blueprint $table) {
            $table->increments('id');
            $table->string('nombre');
            $table->string('descripcion')->nullable();
            $table->timestamps();
        });
        \Illuminate\Support\Facades\DB::table('cm_complicacionpartos')->insert([
    ...
    {
        Schema::dropIfExists('cm_complicacionpartos');
    }
}
