...
class CreateAsS2sTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        DB::statement("ALTER TABLE `as_s1vids` 
                            ADD COLUMN `nombreArchivo` VARCHAR(190) NULL DEFAULT NULL AFTER `fechaProceso`");

        Schema::create('as_s2s', function (Blueprint $table) {
