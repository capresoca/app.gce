...
class AlterEstadoFieldInAuAutsolicitudesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        DB::statement("ALTER TABLE `au_autsolicitudes`
	        CHANGE COLUMN `estado` `estado` ENUM('Registrada','Negada','Autorizada','Autorizada Parcialemente','Confirmada','Anulada') NULL DEFAULT NULL;
        ");
