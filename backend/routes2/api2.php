...
//Route::get('incapacidades/solicitud', 'AtencionUsuario\IncapacidadController@getPedfSolicitud');
...
//	Route::get('usuarios/search/{per_page?}/{search?}', 'GestionSeguridad\UsuarioController@search');
    ...
    //Route::get('afitramites/search/{per_page?}/{search?}','Aseguramiento\AfitramiteController@search');
    //Route::apiResource('afitramites', 'Aseguramiento\AfitramiteController');
    ...
    //Route::apiResource('respuestas'. 'Aseguramiento\BDUARespuestaController');
    //Route::apiResource('archivoreportes', 'Aseguramiento\ArchivoreporteController');
    //Route::get('archivoreportes/download/{archivoreporte}', 'Aseguramiento\ArchivoreporteController@download');
