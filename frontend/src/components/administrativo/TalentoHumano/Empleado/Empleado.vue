<template>
  <v-card>
    <toolbar-list :info="infoComponent" btnplus btnplustitle="Agregar item" title= "Empleado" subtitle="Registro y gestión"/>
    <data-table
...
<script>
  ...
  export default {
    ...
    computed: {
      infoComponent () {
        return this.$store.getters.getInfoComponent('empleado')
      }
    }
  }
</script>
