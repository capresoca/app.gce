...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.axios.get('tramites/traslados-pendiente?traslado_subsidiado=1').then(res => {
        console.log('resto', res)
        this.procesosTrasladoS1 = res.data.traslados_subsidiado
        this.pagination.totalItems = this.procesosTrasladoS1.length
