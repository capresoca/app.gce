...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.axios.get('tramites/pendiente?novedades_contributivo=1').then(res => {
        this.procesosNC = res.data.novedades_contributivo
        this.pagination.totalItems = this.procesosNC.length
