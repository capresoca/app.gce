    ...
    <v-layout row wrap>
      <v-flex xs12 sm12 :md9="!value.id">
        <postulador-v3
          ...
          :hint="`${value && value.tercero ? value.tercero.identificacion_completa : ''}`"
          item-text="nombre_completo"
          label="Tercero"
          route="terceros"
          model="terceros"
          model-state="itemTercero"
          model-create
          ...
          @input="val => value.gn_tercero_id = val ? val.id : null"
        ></postulador-v3>
<!--        <postulador-v2-->
...
<!--        ></postulador-v2>-->
      ...
      <v-slide-x-reverse-transition>
        <v-flex
          ...
          :md4="!value.id"
          :md8="value.id"
          v-if="value.rs_tipentidade_id && (value.rs_tipentidade_id === 1 || value.rs_tipentidade_id === 6)"
        >
          <v-combobox
      ...
      <v-flex
        xs12
        :sm12="(value.rs_tipentidade_id === 1 || value.rs_tipentidade_id === 6)"
        :sm8="value.id && (value.rs_tipentidade_id !== 1 && value.rs_tipentidade_id !== 6)"
        :md12="value.id && (value.rs_tipentidade_id === 1 || value.rs_tipentidade_id === 6)"
        :md8="value.id && (value.rs_tipentidade_id !== 1 && value.rs_tipentidade_id !== 6)"
      >
        <v-text-field
          label="Nombre"
      ...
      <v-slide-x-reverse-transition>
        <v-flex xs12 sm6 md3 v-if="value.rs_tipentidade_id && (value.rs_tipentidade_id === 1 || value.rs_tipentidade_id === 6 || value.rs_tipentidade_id === 2)">
          <v-text-field
    ...
    <v-layout row wrap v-if="value.rs_tipentidade_id === 1 || value.rs_tipentidade_id === 6">
      <v-flex d-flex>
        <v-switch
          v-model="value.ive"
...
<script>
  ...
  export default {
    name: 'RegistroEntidadDatosBasicos',
    props: ['value'],
    components: {
