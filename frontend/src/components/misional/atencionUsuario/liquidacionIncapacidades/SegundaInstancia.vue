              ...
              >
                ...
                <v-tooltip top>
                  <v-btn
                    ...
                    color="white"
                    slot="activator"
                    @click="$store.commit('NAV_ADD_ITEM', { ruta: 'detalleIncapacidades', titulo: 'Detalle Incapacidades', parametros: {entidad: props.item, tabOrigin: $store.state.nav.currentItem.split('tab-')[1]} })"
                  >
                ...
                <v-tooltip top v-if="props.item.estado === 'Aprobada'">
                  <v-btn
                    fab
                    dark
                    small
                    color="white"
                    slot="activator"
                    @click="generarReporte(props.item.pr_solicitud_cp_id)"
                  >
                    <v-icon color="accent" v-text="'far fa-file-pdf'"></v-icon>
                  </v-btn>
                  <span>Solicitud CDP</span>
                </v-tooltip>
                <v-tooltip top>
                  <v-btn
                    fab
